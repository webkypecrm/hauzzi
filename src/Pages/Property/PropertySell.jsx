          ...
          <section className="filter">
            <div className="container">
              <div className="main-filter">
                ...
                <div className="fil6">
                  <p className="mb-0"> ¿Necesita más opciones de búsqueda?</p>
                </div>
                <div className="fil7">
                  ...
                  <div className="row gy-4 mt-4">
                    ...
                    <div className="col-xl-6 col-md-6" key={e.id}>
                      ...
                      <div className="feat_property">
                        <Link to={`/propert-details/${e.id}`} state={{ lat: e.latitude, lng: e.longitude,name: e.name,image: e.images[0] ,allProducts: allData.data,}}>
                          <div className="thumb">
                            <img
                              className="img-whp"
                              src={e.images[0]}
                        ...
                        <div className="details">
                          <Link to={`/propert-details/${e.id}`} state={{ lat: e.latitude, lng: e.longitude,name: e.name,image: e.images[0] ,allProducts: allData.data,}}>
                            <div className="tc_content">
                              ...
                              <ul className="prop_details mb0 p-0">
                                <li className="list-inline-item">
                                  <span>
                                    <img src="img/my-img/icon.png" /> {e?.listingDetails?.Habitaciones} Hab.{" "}
                                  </span>
                                </li>
                                <li className="list-inline-item">
                                  <span>
                                    <img src="img/my-img/Vector_1.png" /> {e?.listingDetails?.Baños}{" "}
                                    Baños{" "}
                                  </span>
                                </li>
                                <li className="list-inline-item">
                                  <span>
                                    <img src="img/my-img/icon_1.png" /> {e.maxSize} m2{" "}
                                  </span>
                                </li>
                              </ul>
                            </div>
                          ...
                          <div className="fp_footer d-flex">
                              ...
                              <ul className="fp_meta float-left mb-0 p-0">
                                <li className="list-inline-item">
                                  <span to="#">
                                    ...
                                    />
                                    <span style={{ marginLeft: 5 }}>{e.Customer.name}</span>{" "}
                                  </span>
                                </li>
                              </ul>
                            </Link>
                            <div className="fp_pdate float-right d-flex">
                              ...
                              <Link className="btn-getstarted gt" to="#">
                                <img src="img/my-img/call.png" width="25%" />
                                Llamar{" "}
                              </Link>
                              <Link to="">
                                <i
                          ...
                          <Link to="#">
                            <div className="tc_content">
                              ...
                              <ul className="prop_details mb0 p-0">
                                <li className="list-inline-item">
                                  <span>
                                    <img src="img/my-img/icon.png" /> 4 Hab.{" "}
                                  </span>
                                </li>
                                <li className="list-inline-item">
                                  <span>
                                    <img src="img/my-img/Vector_1.png" /> 2
                                    Baños{" "}
                                  </span>
                                </li>
                                <li className="list-inline-item">
                                  <span>
                                    <img src="img/my-img/icon_1.png" /> 450 m2{" "}
                                  </span>
                                </li>
                              </ul>
                            </div>
                          ...
                          <Link to="#">
                            <div className="tc_content">
                              <div className="title-price">
                                ...
                                <span className="fp_price">$259,000</span>
                              </div>
                              <p>
                                <img src="img/my-img/vector.png" />
                                <span style={{ marginLeft: 5 }}>
                              ...
                              <ul className="prop_details mb0 p-0">
                                ...
                                <li className="list-inline-item">
                                  <span>
                                    <img src="img/my-img/icon_1.png" /> 500 m2{" "}
                                  </span>
                                </li>
                              </ul>
                            </div>
