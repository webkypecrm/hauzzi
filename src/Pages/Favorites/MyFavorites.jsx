...
const MyFavorites = () => {
  ...
  // delete folder property
  const deleteFolderProperty = async (propertyId) => {
    const confirmDelete = window.confirm(
      "Are you sure you want to remove this Property from Folder?"
    );

    if (!confirmDelete) return;
    try {
      const res = await axios.delete(
        `${apiUrl}/property/deletePropertyFolderData/${propertyId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
            ...
            <main className="main">
              <section className="top-btn12">
                <div className="container-lg py-3">
                      ...
                      >
                        ...
                        <div>
                          ...
                          <small className="text-muted d-block">
                            {item?.propertyFolderCount} inmueble
                          </small>
                        </div>
                        <div
                  ...
                  {/* Mis listas */}
                  {folder
                    ? folderPropertyData?.length > 0 && (
                        <Fragment>
                          <h4 className="mb-3">Mis listas</h4>
                          <div className="row g-4">
                            <Slider
                              {...getSliderSettings(folderPropertyData.length)}
                            >
