            ...
            <div className="container">
                            ...
                            <div className="details">
                              <div className="tc_content">
                                <div className="title-price">
                                  ...
                                  <span className="fp_price">$180,000</span>
                                </div>
                                <p>
              ...
              <div className="row mb-3">
                <div className="col-md-7">
                  <h4 className="fw-bold">Sobre Engel Volkers</h4>
                  <p className="m-0">
                  ...
                  <div className="d-flex align-items-center justify-content-between">
                    <h5 className="mb-0 fw-bold">Agentes de Engel Volkers </h5>
                    <Link to="javascript:void(0)" className="primary-text">
                      Ver todos
                    </Link>
                  </div>
                      ...
                      <div className="swiper-slide">
                        <div className="feat_property">
                          <div className="thumb">
                            <img
                              className="img-whp"
                              src="img/my-img/agent-rent-img.jpeg"
                              alt="fp1.jpg"
                            />
                            <div className="thmb_cntnt">
                              <ul className="tag mb-0 p-0">
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  <p>
                    Al trabajar con una agencia en Hauzzi, puedes contactarla
                  ...
                  <p>
                    Al añadir una agencia, Hauzzi compartirá información sobre
                    tu actividad reciente y futura en la plataforma para que tu
                    agencia comprenda mejor tus necesidades y te ayude a
